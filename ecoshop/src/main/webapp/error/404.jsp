...
<body>
	<div class="wavetext">
		...
		<div class="wavegohome waveinput">
			<a href="http://www.17sucai.com">回到 ECOSHOP 首页</a>
		</div>
		<div class="waveclose waveinput">
			<a href="javascript:void(0);"
				onclick="window.opener=null; window.open('','_self');window.close();">关闭这个页面</a>
		</div>
		<div class="waveqcz"></div>
	...
	<div class="waveWrapper waveAnimation">
		<div class="waveWrapperInner bgTop">
			<div class="wave waveTop"
				style="background-image: url('../static/images/wave-top.png')"></div>
		</div>
		<div class="waveWrapperInner bgMiddle">
			<div class="wave waveMiddle"
				style="background-image: url('../static/images/wave-mid.png')"></div>
		</div>
		<div class="waveWrapperInner bgBottom">
			<div class="wave waveBottom"
				style="background-image: url('../static/images/wave-bot.png')"></div>
		</div>
	</div>
</body>
</html>
