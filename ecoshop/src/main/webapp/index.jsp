<%@page import="cn.yznu.eco.utils.auth.UserUtil"%>
<%@page import="cn.yznu.eco.pojo.auth.User"%>
...
<link rel="stylesheet" type="text/css"
	href="static/rs-plugin/css/settings.css" media="screen" />
...
<![endif]-->
	...
	<script type="text/javascript"
		src="static/rs-plugin/js/jquery.tp.t.min.js"></script>
	<script type="text/javascript"
		src="static/rs-plugin/js/jquery.tp.min.js"></script>
...
<body>
		...
		<header class="header-2">
			<div class="container-fluid">
				<div class="sticky">
					...
					<!-- Nav Icon -->
					<a href="#cd-nav" class="cd-nav-trigger"><span
						class="cd-nav-icon"></span> <!-- Svg Icon --> <svg x="0px" y="0px"
        ...
        <circle fill="transparent" stroke="#2d3a4b" stroke-width="1"
					...
					<div class="logo logo-center">
						<a href="#."><img class="img-responsive"
							src="static/images/logo-2.png" alt=""></a>
					</div>
					<!-- Navigation -->
					<nav class="navbar">
						<!-- Nav Right -->
								...
								<li class="dropdown user-acc"><a href="#"
									...
									<ul class="dropdown-menu">
										<li>
											<h6>
												HELLO!
												<%=user != null ? user.getUsername() : "未登录！"%></h6>
										</li>
										<%
										  if (user == null) {
										%>
										...
										%>
										<li><a href="page/succeed.html">个人中心</a></li>
										<li><a href="page/succeed.html">退出</a></li>
									...
									<ul class="dropdown-menu">
										<li>
											<div class="media-left">
												<div class="cart-img">
													<a href="page/shopCar.jsp"> <img class="media-object img-responsive"
														src="static/images/cart-img-1.jpg" alt="...">
													</a>
												</div>
											</div>
											<div class="media-body">
												<h6 class="media-heading">WOOD CHAIR</h6>
												<span class="price">129.00 USD</span> <span class="qty">QTY:
													01</span>
											</div>
										</li>
										<li>
											<div class="media-left">
												<div class="cart-img">
													<a href="#"> <img class="media-object img-responsive"
														src="static/images/cart-img-2.jpg" alt="...">
													</a>
												</div>
											</div>
											<div class="media-body">
										...
										<li class="margin-0">
											<div class="row">
												<div class="col-xs-6">
													<a href="authc/shopCar.jsp" class="btn">查看购物车</a>
												</div>
												<div class="col-xs-6 ">
													<a href="checkout.html" class="btn">清空购物车</a>
												</div>
											</div>
										</li>
									</ul></li>
			...
			<div class="container-fluid">
				<div class="position-center-center">
					...
					<div class="col-lg-7 col-lg-offset-5">
						...
						<h1 class="extra-huge-text">look hot with style</h1>
		...
		<div id="content">
					...
					<div class="new-arrival-list">
						<ul class="row">
							...
							<li class="col-md-6">
								...
								<article>
									<img class="img-responsive"
										src="static/images/new-ar-img-1.jpg" alt="">
									<div class="position-center-center">
										<h4>
								...
								<article>
									<img class="img-responsive"
										src="static/images/new-ar-img-2.jpg" alt="">
									<div class="position-center-center">
										<h4>
											<a href="#.">graphiti tshirt</a>
										</h4>
										<a href="#." class="btn btn-small btn-round">MORE</a>
									</div>
								</article>
							...
							<li class="col-md-6">
								...
								<article>
									<img class="img-responsive"
										src="static/images/new-ar-img-3.jpg" alt="">
									<div class="position-center-center">
										<h4>
											<a href="#.">leather bag</a>
										</h4>
								...
								<article>
									<img class="img-responsive"
										src="static/images/new-ar-img-4.jpg" alt="">
									<div class="position-center-center">
										<h4>
											<a href="#.">female tshirt</a>
										</h4>
										<a href="#." class="btn btn-small btn-round">MORE</a>
									</div>
								</article>
				...
				<div class="container">
					...
					<div class="papular-block block-slide single-img-demos">
						...
						<div class="item">
							<!-- Item img -->
							<div class="item-img">
								<img class="img-1" src="static/images/shop-3-img-1.jpg" alt="">
								<!-- Overlay -->
								<div class="overlay">
									<div class="position-center-center">
										<a href="#." class="btn btn-small btn-round">MORE</a>
						...
						<div class="item">
							<!-- Item img -->
							<div class="item-img">
								<img class="img-1" src="static/images/shop-3-img-2.jpg" alt="">
								<!-- Overlay -->
								<div class="overlay">
									<div class="position-center-center">
										<a href="#." class="btn btn-small btn-round">MORE</a>
						...
						<div class="item">
							<!-- Item img -->
							<div class="item-img">
								<img class="img-1" src="static/images/shop-3-img-3.jpg" alt="">
								<!-- Overlay -->
								<div class="overlay">
									<div class="position-center-center">
										<a href="#." class="btn btn-small btn-round">MORE</a>
						...
						<div class="item">
							<!-- Item img -->
							<div class="item-img">
								<img class="img-1" src="static/images/shop-3-img-4.jpg" alt="">
								<!-- Overlay -->
								<div class="overlay">
									<div class="position-center-center">
										<a href="#." class="btn btn-small btn-round">MORE</a>
			...
			<section class="special-offers">
				<div class="container">
					<div class="col-md-8 center-block">
						<h4>special</h4>
						<h1 class="extra-huge-text">women’s sale</h1>
			...
			<!-- News Letter -->
			<section
				class="news-letter style-2 padding-top-150 padding-bottom-150">
				<div class="container">
			...
			<div class="container">
				...
				<div class="col-md-3">
					<div class="about-footer">
						<img class="margin-bottom-30" src="static/images/logo-foot.png"
							alt="">
						<p>
						...
						<nav>
							<ul class="cd-primary-nav">
								...
								<li class="drop-menu"><a href="#." class="title collapsed"
									data-toggle="collapse" data-target="#down-1"> shop </a>
									<div class="collapse" id="down-1">
										<div class="well">
											<ul>
												...
												<li><a href="product-detail_01.html">Product Detail
														01</a></li>
												<li><a href="product-detail_02.html">Product Detail
														02</a></li>
